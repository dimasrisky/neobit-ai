...
const Login: React.FC = () => {
    ...
    const signInWithFaccebook = async () => {
        ...
        <div className='w-[438px] flex flex-col text-white'>
            ...
            <form action="" onSubmit={submitForm}>
                ...
                <div className='mt-[22px] flex flex-col gap-[16px]'>
                    ...
                    <button type='submit' className='w-full bg-primary-blue py-[13px] flex justify-center items-center rounded-[8px] text-[16px] text-white hover:bg-primary-dark-blue hover:ring-2 hover:ring-primary-light-blue transition-all duration-300'>
                        {isLoadingEmailAuth ? <div className="w-7 h-7 border-4 border-t-primary-white border-gray-200 rounded-full animate-spin"></div> : 'Sign in'}
                    </button>
                </div>
            </form>
            <div className='w-full border-t-[0.4px] my-[22px] border-primary-white'></div>
            <div className='w-full flex flex-col gap-[21px]'>
                <div onClick={signInWithGoogle} className='w-full bg-primary-white font-semibold text-primary-black py-[13px] rounded-[8px] text-[16px] flex justify-center items-center gap-[14px] cursor-pointer' >
                ...
                <div onClick={signInWithFaccebook} className='w-full bg-primary-white font-semibold text-primary-black py-[13px] rounded-[8px] text-[16px] flex justify-center items-center gap-[14px] cursor-pointer' >
