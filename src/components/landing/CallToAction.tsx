...
const CallToAction: React.FC = () => {
  return (
    <section id='call-to-action'>
        <div className='w-full flex justify-center items-center mt-[100px] lg:mt-[159px] bg-primary-black rounded-[10px] shadow-md shadow-primary-white border border-primary-white px-[20px] py-[39px] lg:py-[71px]'>
